...
<html>
    <head>
       ...
       <!-- <script type="text/javascript" src="https://my.zoomiya.com/iframechat?task=serverTasks.getScript&lang=ru" async defer ></script> -->
    </head>
    <body>
        <div class="top-bg">
            ...
            <div class="promo">
                ...
                <span class="subhead">Новые автомобили от Эконом до Бизнес-класса от 10 000 тенге с оформлением за 15 минут</span>
                <div class="action wow fadeInLeft">
                    ...
                    <div class="counter" data-time="Dec,24,2019,00:00:00">
                        <div class="frame"></div>
                ...
                <ul class="vantage wrap wow fadeInUp">
                    <li>
                        ...
                        <span>5 лет</span><br/>на рынке проката
                    </li>
        ...
        <div class="process" data-block="2">
            <h2>Как арендовать авто у нас?</h2>
            <div class="step wrap">
                <div class="item">
                        ...
                        <ul>
                            <li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="1"><img class="margin" src="files/LPrado.jpg" alt=""/></a>
                                    <!--<div class="info">
									...
									-->
                                    <span class="price">От 27 000 тенге в сутки</span>
                            ...
                            <li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="24"><img class="margin"  src="files/x6/preview.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>&nbsp;</span>
                                        <span>Объем двигателя - 3,0 л.</span>
                                        <span>&nbsp;</span>
                                    </div>-->
                                    <span class="price">От 45 000 тенге в сутки</span>
                                    <a class="button" href="">Забронировать авто<span>BMW X6</span></a>
                                    <a class="more" href="" data-id="24">Подробнее</a>
                                </div>
                            </li>
                            <li>
                                <div class="in">
                                    <span class="name">Mercedes Benz S55</span>
                                    <a class="img" href="" data-id="3"><img class="margin"  src="files/Mbenz.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>Коробка передач - автоматическая</span>
                            ...
                            <li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="19"><img class="margin"  src="files/BMW.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>Коробка передач - автоматическая</span>
                                        <span>Объем двигателя - 3,0 л.</span>
                            ...
                            <li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="4"><img class="margin"  src="files/g55/preview.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>Коробка передач - автоматическая</span>
							...
							<li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="23"><img class="margin"  src="files/rx330/preview.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>&nbsp;</span>
                                        <span>Объем двигателя - 3,3 л.</span>
                                        <span>&nbsp;</span>
                                    </div>-->
                                    <span class="price">От 15 000 тенге в сутки</span>
                                    <a class="button" href="">Забронировать авто<span>Lexus RX330</span></a>
                                    <a class="more" href="" data-id="23">Подробнее</a>
                                </div>
                            </li>
                        ...
                        <ul>
                            <li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="5"><img class="margin"  src="files/Camry55.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>Коробка передач - автоматическая</span>
                            ...
                            <li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="6"><img class="margin"  src="files/Lada_Vesta.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>Коробка передач - автоматическая</span>
                                    ...
                                    <a class="button" href="">Забронировать авто<span>Lada Vesta</span></a>
                            ...
                            <li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="8"><img class="margin"  src="files/toyotaC2017/toyotaC2017_0.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>Коробка передач - автоматическая</span>
                                    ...
                                    <a class="button" href="">Забронировать авто<span>Toyota Corolla 2017 г.в.</span></a>
                            ...
                            <li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="26"><img class="margin"  src="files/VolkswagenP/VolkswagenP_0.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>&nbsp;</span>
                                        <span>Объем двигателя - 1,6 л.</span>
                                        <span>&nbsp;</span>
                                    ...
                                    <a class="button" href="">Забронировать авто<span>Volkswagen Polo</span></a>
                                    <a class="more" href="" data-id="26">Подробнее</a>
                                </div>
                            </li>
                            <!--
                            <li>
                            ...
                            <li>
                                <div class="in">
                                    <span class="name">Toyota <br>Camry 55</span>
                                    <a class="img" href="" data-id="18"><img class="margin"  src="files/Camry552015.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>Коробка передач - автоматическая</span>
                                        <span>Объем двигателя - 2,5 л.</span>
                                        <span>Расход бензина - 9 л/100км</span>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="12"><img class="margin"  src="files/miniven.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>Коробка передач - автоматическая</span>
                            ...
                            <li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="13"><img class="margin"  src="files/terrano.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>Коробка передач - автоматическая</span>
                                        <span>Объем двигателя - 2,0 л.</span>
                                        <span>Расход бензина - 11,0 л/100км</span>
                                    </div>-->
                                    <span class="price">От 11 000 тенге в сутки</span>
                                    <a class="button" href="">Забронировать авто<span>Nissan Terrano</span></a>
                            ...
                            <li>
                                <div class="in">
                                    ...
                                    <div class="info">
                                        <span>Коробка передач - механическая</span>
                                        <span>Объем двигателя - 3.2 л, б/газ</span>
                                        <span>Расход бензина - 10,6 л/100км</span>
                                    </div>
                                    <span class="price">От 16 000 тенге в сутки</span>
                                    <a class="button" href="">Забронировать авто<span>Volkswagen Caravelle</span></a>
                                    <a class="more" href="" data-id="21">Подробнее</a>
                                </div>
                            </li>
                            -->
                            <li>
                                <div class="in">
                                    ...
                                    <a class="img" href="" data-id="22"><img class="margin"  src="files/starex.jpg" alt=""/></a>
                                    <!--<div class="info">
                                        <span>Коробка передач - механическая</span>
                                        <span>Объем двигателя - 2,5 л.</span>
                                        <span>Расход бензина - 11,0 л/100км</span>
                                    </div>-->
                                    <span class="price">От 20 000 тенге в сутки</span>
                                    <a class="button" href="">Забронировать авто<span>Hyundai Grand Starex</span></a>
                                    <a class="more" href="" data-id="22">Подробнее</a>
                                </div>
                            </li>
                            <!-- новые машинки
                                                        <li>
        ...
        <div class="unow">
            <h2>УСПЕВАЙ ВСЁ С <span>«ИМИДЖАВТО»</span></h2>
            <div class="wrapper">
                <div class="lcol item1">Планируете приехать <br />в Алматы?</div>
                <div class="rcol">Позаботьтесь о комфортном перемещении из аэропорта! Наслаждайтесь свободой, мобильностью, скоростью, арендовав отличную машину в «Имиджавто»!</div>
                <div class="lcol grey item2">Загнали машину <br />на ТО?</div>
                <div class="rcol grey">Не стоить откладывать важные дела, будучи без автомобиля! Выберите машину – и встречайтесь с друзьями, отдыхайте, делайте покупки, завершайте начатое!</div>
                <div class="lcol item3">Запланировано важное событие и нужна хорошая машина?</div>
                <div class="rcol">Сияющий новый автомобиль от «Имиджавто» станет верным спутником и другом на вечер. Выбирайте из 18 лучших моделей!</div>
                <div class="lcol grey item4">Нужно успеть завершить дела до отъезда из города?</div>
                <div class="rcol grey">Автопрокат «Имиджавто» избавит вас от головной боли: на быстром новом авто вы легко справитесь с незаконченными делами!</div>
        ...
        <div class="access">
            ...
            <ul>
                <li>
                    <div class="img">
                        <a href="" data-id="1"><img class="margin" src="files/access-1.png" alt=""/></a>
                    </div>
                    <span class="name">Регистраторы</span>
                    <span class="price">От 1500 тенге</span>
                ...
                <li>
                    ...
                    <span class="name">Багажник для лыж </span>
                    <span class="price">От 3000 тенге</span>
                    <a class="order" href="">Заказать<span>Багажник для лыж </span></a>
                    <a class="more" href="" data-id="6">Подробнее</a>
                </li>
                <li>
                    <div class="img">
                    ...
                    <span class="name">Багажник для велосипеда </span>
                    <span class="price">От 3000 тенге</span>
                    <a class="order" href="">Заказать<span>Багажник для велосипеда </span></a>
                    <a class="more" href="" data-id="7">Подробнее</a>
                </li>				
            </ul>
        </div><!-- .access -->
        ...
        <div class="action-box">
            <div class="wrap">
                <div class="counter" data-time="Dec,20,2019,00:00:00">
                    <span class="title">До конца акции:</span><br/>
                    <span class="item">
                        <span class="h">00</span>часов
                    </span>
                ...
                <div class="form">
                    <div class="in">
                        ...
                        <p>Оставьте заявку 
                            и получите <span class="bold">Подарок!</span></p>
        ...
        <div class="reviews" data-block="6">
            ...
            <ul>
				...
				<li>
                    ...
                    <span class="who">Довольный иностранный клиент</span>
                </li>
            </ul>
        </div><!-- .reviews -->

		<div class="rent">
            <h2>Аренда для <span>юридических лиц</span></h2>
            <div class="wrapper">
                <div class="businesman">
                    <div class="col1">
                        <div class="item">ГИД-ВОДИТЕЛЬ</div>
                        <div class="item">БИЗНЕС-ВСТРЕЧА</div>
                        <div class="item">ТРАНСФЕР</div>
                    </div>
                    <div class="col2">
                        <div class="item">ОПЕРАТИВНЫЙ ЛИЗИНГ</div>
                        <div class="item">АУТСОРСИНГ</div>
                    </div>
                </div>
            </div>
        </div>
